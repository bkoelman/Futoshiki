...
describe('BoardTextConverter', () => {
    ...
    describe('boardToText', () => {
        it('should format board correctly', () => {
            ...
            getExistingCell(board, 'A1').setCandidates([2, 5]);
            getExistingCell(board, 'A5').setCandidates([1, 2, 3, 4, 5]);

            getExistingCell(board, 'B3').setCandidates([3, 4, 5]);

            getExistingCell(board, 'C3').setFixedValue(2);
            getExistingCell(board, 'C5').setCandidates([1, 3, 4]);

            getExistingCell(board, 'D1').setUserValue(3);
            getExistingCell(board, 'D2').setUserValue(2);
            getExistingCell(board, 'D3').setCandidates([1]);
            getExistingCell(board, 'D5').setCandidates([4, 5]);

            getExistingCell(board, 'E1').setFixedValue(4);
            getExistingCell(board, 'E4').setCandidates([1, 2, 3]);
