...
describe('HintProvider', () => {
  ...
  describe('NakedPairTripleStrategy', () => {
    it('should eliminate candidate pair from row on the board', () => {
      ...
      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`Naked pair (2,3) in cells (B2,B5) eliminated '2' and '3' from 3 other cells in that row.`);
      expectBoard(
        board,
        `
          +------+------+-------+------+----+
    ...
    it('should eliminate candidate pair from row in single cell', () => {
      ...
      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`Naked pair (2,3) in cells (B2,B5) eliminated '2' and '3' from B4.`);
      expectBoard(
        board,
        `
          +------+------+-------+------+----+
    ...
    it('should eliminate candidate pair from column on the board', () => {
      ...
      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`Naked pair (3,4) in cells (A1,E1) eliminated '3' and '4' from 3 other cells in that column.`);
      expectBoard(
        board,
        `
          +------+-----+------+------+--------+-------+
    ...
    it('should eliminate candidate pair from column in single cell', () => {
      ...
      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`Naked pair (3,4) in cells (A1,E1) eliminated '3' and '4' from F1.`);
      expectBoard(
        board,
        `
          +------+-----+------+------+--------+-------+
    ...
    it('should eliminate candidate triple from row on the board', () => {
      ...
      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`Naked triple (1,2,3) in cells (E1,E4,E5) eliminated '1', '2' and '3' from 2 other cells in that row.`);
      expectBoard(
        board,
        `
          +------+-----+------+------+----+
    ...
    it('should eliminate candidate triple from row in single cell', () => {
      ...
      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`Naked triple (1,2,3) in cells (E1,E4,E5) eliminated '1', '2' and '3' from E3.`);
      expectBoard(
        board,
        `
          +------+------+------+------+----+
    ...
    it('should eliminate candidate triple from column in single cell', () => {
      ...
      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`Naked triple (3,4,5) in cells (C2,D2,F2) eliminated '3', '4' and '5' from G2.`);
      expectBoard(
        board,
        `
          +------+-------+----+-------+----+------+--------+
  ...
  describe('NakedQuadStrategy', () => {
    ...
    it('should eliminate candidate quad from row in single cell', () => {
      ...
      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`Naked quad (3,4,5,6) in cells (C1,C4,C5,C6) eliminated '3', '4', '5' and '6' from C7.`);
      expectBoard(
        board,
        `
          +-------+--------+---------+--------+-----+--------+---------+----------+----------+
    ...
    it('should eliminate candidate quad from column in single cell', () => {
      ...
      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`Naked quad (1,2,3,4) in cells (B3,D3,F3,G3) eliminated '1', '2', '3' and '4' from C3.`);
      expectBoard(
        board,
        `
          +-------+---------+---------+-------+---------+---------+-------+
  ...
  describe('HiddenQuadStrategy', () => {
    it('should find hidden quad in row on the board', () => {
      const { provider, board } = createHintProviderForBoard(`
        +---------+-----------+-----------+----------+----------+----------+----------+-----+----------+
        |  6789   | 123456789 |   56789   | 12345678 | 12345689 | 12345678 |   789    > 567 <   679    |
        +----v----+-----------+-----v-----+----------+----------+----------+----------+--^--+----v-----+
        |  5678   |    123    |    456    <   567    | 1234568  |    #9    | 1234578  | 78  | 1234567  |
        +----v----+-----^-----+-----v-----+----^-----+----------+----------+----^-----+--v--+----------+
        |  3567   >    234    <    345    |   678    | 12345689 | 2345678  | 2345789  | 567 | 12345679 |
        +---------+-----------+-----------+----v-----+----------+----v-----+----------+-----+----------+
        |  1235   | 123456789 | 23456789  | 1234567  | 12345689 | 1234567  | 12345789 | 123 | 12345679 |
        +----^----+-----------+-----v-----+----------+----------+----------+----------+--^--+----------+
        |  2356   <   3567    |  123567   |    !9    |  12356   <  23567   |   123    < #4  |    #8    |
        +---------+-----^-----+-----------+----------+----------+----------+----------+--v--+----------+
        |  56789  >   45678   | 123456789 | 12345678 | 12345689 | 12345678 | 12345789 | 23  >    12    |
        +---------+-----------+-----------+----------+----------+----------+----------+-----+----------+
        |   #4    |    123    |   5678    |  235678  >  12356   |  235678  >  12357   | !9  |   3567   |
        +---------+-----^-----+-----v-----+----v-----+----------+----v-----+----------+-----+----v-----+
        |   89    |   2345    <   3457    |  123457  |    89    |  123457  |    #6    | 123 <   2345   |
        +---------+-----------+-----------+----------+----------+----------+----------+-----+----v-----+
        | 1235689 | 12345689  |  2345689  > 1234568  |    #7    | 1234568  |    89    > 568 |   1234   |
        +---------+-----------+-----------+----------+----------+----------+----------+-----+----------+`);

      const hasChanges = provider.runAtBoard();

      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`Hidden quad (1,2,3,4) in row of cells (A2,A4,A5,A6) eliminated others in these cells.`);
      expectBoard(
        board,
        `
          +---------+-----------+-----------+----------+----------+----------+----------+-----+----------+
          |  6789   |   1234    |   56789   |   1234   |   1234   |   1234   |   789    > 567 <   679    |
          +----v----+-----------+-----v-----+----------+----------+----------+----------+--^--+----v-----+
          |  5678   |    123    |    456    <   567    | 1234568  |    #9    | 1234578  | 78  | 1234567  |
          +----v----+-----^-----+-----v-----+----^-----+----------+----------+----^-----+--v--+----------+
          |  3567   >    234    <    345    |   678    | 12345689 | 2345678  | 2345789  | 567 | 12345679 |
    ...
    it('should find hidden quad in row for single cell', () => {
      const { provider, board } = createHintProviderForBoard(`
        +---------+-----------+-----------+----------+----------+----------+----------+-----+----------+
        |  6789   | 123456789 |   56789   | 12345678 | 12345689 | 12345678 |   789    > 567 <   679    |
        +----v----+-----------+-----v-----+----------+----------+----------+----------+--^--+----v-----+
      ...
      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`Hidden quad (1,2,3,4) in row of cells (A2,A4,A5,A6) eliminated others in A2.`);
      expectBoard(
        board,
        `
          +---------+-----------+-----------+----------+----------+----------+----------+-----+----------+
          |  6789   |   1234    |   56789   | 12345678 | 12345689 | 12345678 |   789    > 567 <   679    |
          +----v----+-----------+-----v-----+----------+----------+----------+----------+--^--+----v-----+
          |  5678   |    123    |    456    <   567    | 1234568  |    #9    | 1234578  | 78  | 1234567  |
          +----v----+-----^-----+-----v-----+----^-----+----------+----------+----^-----+--v--+----------+
          |  3567   >    234    <    345    |   678    | 12345689 | 2345678  | 2345789  | 567 | 12345679 |
    ...
    it('should find hidden quad in column on the board', () => {
      const { provider, board } = createHintProviderForBoard(`
        +-----------+-----------+----------+-----------+----------+----------+------+-----------+---------+
        |  1234589  |   2345    >   1234   |    89     |    #6    |  12345   |  #7  >   12345   | 123458  |
        +-----------+-----^-----+----^-----+-----v-----+----------+----^-----+------+-----------+---------+
        |   56789   >   35678   |  235789  |   5678    |  123578  |  23568   |  #4  | 12356789  | 1235678 |
        +-----------+-----------+----------+-----v-----+----^-----+----^-----+------+-----------+---------+
        | 23456789  |   56789   | 2345789  |   34567   | 2345789  |  345689  |  !1  | 23456789  |  23456  |
        +-----------+-----v-----+----------+-----v-----+----------+----------+--^---+-----------+----^----+
        | 23456789  |   45678   >   3457   >   23456   >   1234   <  23456   | 2359 | 123456789 |  34567  |
        +-----v-----+-----------+----------+-----^-----+----------+----^-----+------+-----------+----^----+
        | 12345678  < 23456789  | 2345789  |  3456789  | 12345789 |  34568   <  59  | 123456789 |  45678  |
        +-----------+-----------+----v-----+-----------+----------+----------+------+-----------+---------+
        | 123456789 | 123456789 | 1234578  | 123456789 | 12345789 | 12345689 | 2359 >   1234    | 1234567 |
        +-----------+-----------+----------+-----------+----------+----------+------+-----^-----+----^----+
        |  345789   | 12345789  | 12345789 | 12345789  | 12345789 | 1234589  |  #6  >   2345    | 234578  |
        +-----v-----+-----------+----------+-----------+----------+----------+------+-----------+---------+
        |  2345678  |  3456789  | 12345789 |  3456789  |   5789   >   4568   >  35  >    234    >   123   |
        +-----v-----+-----v-----+----------+-----v-----+----------+----------+------+-----v-----+---------+
        |   1234    <   2345    <    #6    >   2345    >   1234   |    !7    <  #8  |    123    |   !9    |
        +-----------+-----------+----------+-----------+----------+----------+------+-----------+---------+`);

      const hasChanges = provider.runAtBoard();

      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`Hidden quad (6,7,8,9) in column of cells (B8,C8,D8,E8) eliminated others in these cells.`);
      expectBoard(
        board,
        `
          +-----------+-----------+----------+-----------+----------+----------+------+-------+---------+
          |  1234589  |   2345    >   1234   |    89     |    #6    |  12345   |  #7  > 12345 | 123458  |
          +-----------+-----^-----+----^-----+-----v-----+----------+----^-----+------+-------+---------+
          |   56789   >   35678   |  235789  |   5678    |  123578  |  23568   |  #4  | 6789  | 1235678 |
          +-----------+-----------+----------+-----v-----+----^-----+----^-----+------+-------+---------+
          | 23456789  |   56789   | 2345789  |   34567   | 2345789  |  345689  |  !1  | 6789  |  23456  |
          +-----------+-----v-----+----------+-----v-----+----------+----------+--^---+-------+----^----+
          | 23456789  |   45678   >   3457   >   23456   >   1234   <  23456   | 2359 | 6789  |  34567  |
          +-----v-----+-----------+----------+-----^-----+----------+----^-----+------+-------+----^----+
          | 12345678  < 23456789  | 2345789  |  3456789  | 12345789 |  34568   <  59  | 6789  |  45678  |
          +-----------+-----------+----v-----+-----------+----------+----------+------+-------+---------+
          | 123456789 | 123456789 | 1234578  | 123456789 | 12345789 | 12345689 | 2359 > 1234  | 1234567 |
          +-----------+-----------+----------+-----------+----------+----------+------+---^---+----^----+
          |  345789   | 12345789  | 12345789 | 12345789  | 12345789 | 1234589  |  #6  > 2345  | 234578  |
    ...
    it('should find hidden quad in column for single cell', () => {
      const { provider, board } = createHintProviderForBoard(`
        +-----------+-----------+----------+-----------+----------+----------+------+-----------+---------+
        |  1234589  |   2345    >   1234   |    89     |    #6    |  12345   |  #7  >   12345   | 123458  |
        +-----------+-----^-----+----^-----+-----v-----+----------+----^-----+------+-----------+---------+
      ...
      const hasChanges = provider.runAtCoordinate(Coordinate.fromText('B8', board.size));

      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`Hidden quad (6,7,8,9) in column of cells (B8,C8,D8,E8) eliminated others in B8.`);
      expectBoard(
        board,
        `
          +-----------+-----------+----------+-----------+----------+----------+------+-----------+---------+
  ...
  describe('XWingStrategy', () => {
    it('should find X-Wing in row on the board', () => {
      const { provider, board } = createHintProviderForBoard(`
        +-------+----+-----+----+----+-----+------+-------+
        |  58   | !1 | 23  < !4 < #7 | 23  | 568  |  568  |
        +---v---+-^--+-----+----+----+-----+------+-------+
        |  457  | #2 | 57  | #6 | #3 | 14  | 1458 | 1578  |
        +-------+----+-----+----+-v--+-----+------+-------+
        | 34578 | 78 | 567 | !1 | !2 | 68  > 456  >  35   |
        +-------+----+-----+-^--+----+-----+------+---^---+
        |  !1   | 78 | 567 | !3 | !4 < 68  |  !2  | 5678  |
        +-------+----+-----+----+----+-----+------+-------+
        |  34   | !5 | !8  > !7 | #1 | 234 | 346  |  236  |
        +-------+-v--+-----+----+----+-----+------+-------+
        |  78   > !4 | 23  < !5 < !6 | 123 |  38  | 12378 |
        +-------+----+-----+----+----+-----+--v---+-------+
        |  #2   | #6 | !4  | !8 > #5 < !7  |  13  |  13   |
        +-------+----+--v--+----+-^--+-----+------+-------+
        |  #6   | #3 | !1  | #2 | !8 | #5  |  !7  >  !4   |
      ...
      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`X-Wing of (6) in (A7,A8,E7,E8) eliminates '6' from 2 other cells in columns.`);
      expectBoard(
        board,
        `
          +-------+----+-----+----+----+-----+------+-------+
          ...
          |  457  | #2 | 57  | #6 | #3 | 14  | 1458 | 1578  |
          +-------+----+-----+----+-v--+-----+------+-------+
          | 34578 | 78 | 567 | !1 | !2 | 68  >  45  >  35   |
          +-------+----+-----+-^--+----+-----+------+---^---+
          |  !1   | 78 | 567 | !3 | !4 < 68  |  !2  |  578  |
          +-------+----+-----+----+----+-----+------+-------+
          |  34   | !5 | !8  > !7 | #1 | 234 | 346  |  236  |
          +-------+-v--+-----+----+----+-----+------+-------+
          |  78   > !4 | 23  < !5 < !6 | 123 |  38  | 12378 |
    ...
    it('should find X-Wing in row for single cell', () => {
      const { provider, board } = createHintProviderForBoard(`
        +-------+----+-----+----+----+-----+------+-------+
        |  58   | !1 | 23  < !4 < #7 | 23  | 568  |  568  |
        +---v---+-^--+-----+----+----+-----+------+-------+
      ...
      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`X-Wing of (6) in (A7,A8,E7,E8) eliminates '6' from C7.`);
      expectBoard(
        board,
        `
          +-------+----+-----+----+----+-----+------+-------+
    ...
    it('should find X-Wing in column on the board', () => {
      const { provider, board } = createHintProviderForBoard(`
        +--------+--------+-------+-------+------+--------+------+-----+
        | 123567 | 34567  > 23456 | 4567  | 567  |   12   | 4567 < !8  |
        +--------+--------+-------+-------+--v---+--------+--v---+-----+
        |   78   >   67   >  56   |  #1   |  #4  |  5678  |  !3  | !2  |
        +--------+--------+-------+-------+------+--------+------+--^--+
        |   #4   <  5678  |  !1   |  567  < 678  | 35678  >  !2  | 35  |
        +---v----+--------+-------+-------+------+--------+------+--^--+
        |   23   >   12   |  78   | 45678 |  13  | 45678  |  45  < 56  |
        +--------+--------+-------+-------+------+--------+------+--^--+
        |  1256  |  2456  | 2456  |  #3   <  56  |   12   |  !8  | !7  |
        +--------+---^----+-------+---v---+------+--------+--v---+-----+
        | 35678  | 345678 |  78   |  !2   | 5678 >  3456  < 4567 | !1  |
        +--------+--------+-------+-------+------+--------+------+-----+
        |  567   >  456   >  345  | 45678 |  !2  < 345678 |  !1  < 345 |
        +---^----+--------+---v---+-------+------+--------+------+--^--+
        |  678   |  123   <  234  | 45678 |  13  |  678   > 567  > 456 |
        +--------+--------+-------+-------+------+--------+------+-----+`);

      const hasChanges = provider.runAtBoard();

      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`X-Wing of (8) in (C2,F2,C5,F5) eliminates '8' from 3 other cells in rows.`);
      expectBoard(
        board,
        `
          +--------+--------+-------+-------+------+--------+------+-----+
          ...
          |   78   >   67   >  56   |  #1   |  #4  |  5678  |  !3  | !2  |
          +--------+--------+-------+-------+------+--------+------+--^--+
          |   #4   <  5678  |  !1   |  567  < 678  |  3567  >  !2  | 35  |
          +---v----+--------+-------+-------+------+--------+------+--^--+
          |   23   >   12   |  78   | 45678 |  13  | 45678  |  45  < 56  |
          +--------+--------+-------+-------+------+--------+------+--^--+
          |  1256  |  2456  | 2456  |  #3   <  56  |   12   |  !8  | !7  |
          +--------+---^----+-------+---v---+------+--------+--v---+-----+
          |  3567  | 345678 |   7   |  !2   | 5678 >  3456  < 4567 | !1  |
          +--------+--------+-------+-------+------+--------+------+-----+
          |  567   >  456   >  345  | 45678 |  !2  < 345678 |  !1  < 345 |
          +---^----+--------+---v---+-------+------+--------+------+--^--+
          |  678   |  123   <  234  | 45678 |  13  |  678   > 567  > 456 |
    ...
    it('should find X-Wing in column for single cell', () => {
      const { provider, board } = createHintProviderForBoard(`
        +--------+--------+-------+-------+------+--------+------+-----+
        | 123567 | 34567  > 23456 | 4567  | 567  |   12   | 4567 < !8  |
        +--------+--------+-------+-------+--v---+--------+--v---+-----+
      ...
      const hasChanges = provider.runAtCoordinate(Coordinate.fromText('C6', board.size));

      expect(hasChanges).toBeTruthy();
      expect(provider.explanationText).toBe(`X-Wing of (8) in (C2,F2,C5,F5) eliminates '8' from C6.`);
      expectBoard(
        board,
        `
          +--------+--------+-------+-------+------+--------+------+-----+
